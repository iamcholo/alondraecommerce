define(
    ...
    function (angular)
    {
      var app = angular.module('app', [
        ...
        'app.controllers.custom.games',
        'app.controllers.custom.game_engine',
        'app.controllers.custom.video',
        'app.controllers.navigation',
        'app.services.user',
        'app.services.login',
        'app.services.custom.games',
        'app.services.custom.game_engine',
        'app.services.custom.video',
        'app.services.posts',
        'app.services.pages',
        'app.services.tags',
        ...
        'app.routes.posts',
        'app.routes.custom.games',
        'app.routes.custom.game_engine',
        'app.routes.custom.video',
        'app.routes.pages',
        'app.routes.media',
